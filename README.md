...
- 🤖 **AI × Python**を活用した業務改善・Webアプリケーション開発
- ⚙️ **FastAPI / Streamlit / SQL**を用いたバックエンド・Webアプリ開発
- 📊 Excel・VBA・Pythonによる業務効率化・自動化
- 🗄️ データベース設計・CRUD・API設計
- 🧪 テスト・異常系検証・品質改善
- 💡 20年以上のバックオフィス経験を活かした、現場目線での要件整理・業務設計
- 🤝 ChatGPT・Claude・Gemini・GitHub Copilotなどを活用したAI協働開発
...
**「現場を知っているからこそ作れる、AI × Pythonの業務改善・システム開発」**
